  ...
  constructor(private route: ActivatedRoute) {
    this.items = [
      ...
      },
      {
        ...
        description:
          // tslint:disable-next-line:max-line-length
          '<p>Jawab :</p> <p>Anda dapat menghubungi call center dengan nomor <a href="tel:08943091801"><strong>08943091801</strong></a> atau melalui email <a href="mailto:sapawarga@jabarprov.go.id"><strong>sapawarga@jabarprov.go.id</strong></a></p>',
        expanded: false
      }
    ];
  }
